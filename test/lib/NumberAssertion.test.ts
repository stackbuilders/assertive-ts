...
describe("[Unit] NumberAssertion.test.ts", () => {
  ...
  describe(".toBeGreaterThan", () => {
    context("when the value is greater than 2", () => {
      it("returns the assertion instance", () => {
    ...
    context("when the value is NOT greater than 2", () => {
      it("throws an assertion error", () => {
        const test = new NumberAssertion(1);
  ...
  describe(".toBeGreaterThanOrEqualTo", () => {
    context("when the value is greater than or equal to 2", () => {
      it("returns the assertion instance", () => {
        const test = new NumberAssertion(2);
    ...
    context("when the value is NOT greater than or equal to 2", () => {
      it("throws an assertion error", () => {
        const test = new NumberAssertion(1);
  ...
  describe(".toBeLessThan", () => {
    context("when the value is less than 2", () => {
      it("returns the assertion instance", () => {
        const test = new NumberAssertion(1);
    ...
    context("when the value is NOT less than 2", () => {
      it("throws an assertion error", () => {
        const test = new NumberAssertion(3);
  ...
  describe(".toBeLessThanOrEqualTo", () => {
    context("when the value is less than or equal to 2", () => {
      it("returns the assertion instance", () => {
        const test = new NumberAssertion(2);
    ...
    context("when the value is NOT less than or equal to 2", () => {
      it("throws an assertion error", () => {
        const test = new NumberAssertion(3);
  ...
  describe(".toBeBetween", () => {
    context("when the value is between 10 and 12 and is NOT inclusive", () => {
      it("returns the assertion instance", () => {
        const test = new NumberAssertion(11);
        test.toBeBetween({ range: [10, 12], inclusive: true });
        assert.deepStrictEqual(
          test.toBeBetween({ range: [10, 12], inclusive: false }),
          test
        );
        assert.throws(
          () => test.not.toBeBetween({ range: [10, 12], inclusive: false }),
          {
    ...
    context(
      "when the value is NOT between 10 and 12 and is NOT inclusive",
      () => {
        it("throws an assertion error", () => {
    ...
    context("when the value is between 10 and 12 and is inclusive", () => {
      it("returns the assertion instance", () => {
        ...
        assert.throws(
          () => test.not.toBeBetween({ range: [10, 12], inclusive: true }),
          {
    ...
    context("when the value is NOT between 10 and 12 and is inclusive", () => {
      it("throws an assertion error", () => {
        const test = new NumberAssertion(5);
  ...
  describe(".toBeBetween with lowInclusive", () => {
    context(
      "when the value is between 10 and 12 and low limit is NOT inclusive",
      () => {
        it("returns the assertion instance", () => {
          const test = new NumberAssertion(11);
    ...
    context(
      "when the value is NOT between 10 and 12 and low limit is NOT inclusive",
      () => {
        it("throws an assertion error", () => {
          const test = new NumberAssertion(5);
    ...
    context(
      "when the value is between 10 and 12 and low limit is inclusive",
      () => {
        it("returns the assertion instance", () => {
          const test = new NumberAssertion(10);
    ...
    context(
      "when the value is NOT between 10 and 12 and low limit is inclusive",
      () => {
        it("throws an assertion error", () => {
          const test = new NumberAssertion(5);
  ...
  describe(".toBeBetween with highInclusive", () => {
    context(
      "when the value is between 10 and 12 and high limit is NOT inclusive",
      () => {
        it("returns the assertion instance", () => {
          const test = new NumberAssertion(11);
    ...
    context(
      "when the value is NOT between 10 and 12 and high limit is NOT inclusive",
      () => {
        it("throws an assertion error", () => {
          const test = new NumberAssertion(5);
    ...
    context(
      "when the value is between 10 and 12 and high limit is inclusive",
      () => {
        it("returns the assertion instance", () => {
          const test = new NumberAssertion(12);
    ...
    context(
      "when the value is NOT between 10 and 12 and high limit is inclusive",
      () => {
        it("throws an assertion error", () => {
          const test = new NumberAssertion(5);
  ...
  describe(".toBeCloseTo", () => {
    context("when the value is close to 10 with offset 2", () => {
      it("returns the assertion instance", () => {
    ...
    context("when the value is NOT close to 10 with offset 2", () => {
      it("throws an assertion error", () => {
